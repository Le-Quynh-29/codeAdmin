...
AmCharts.translations["export"] || (AmCharts.translations["export"] = {}), AmCharts.translations["export"].en || (AmCharts.translations["export"].en = {
  ...
  var a,
    ...
    download: function download(e, t, a) {
    ...
    addListenerToRemove: function addListenerToRemove(e, t, a) {
    ...
    loadDependencies: function loadDependencies() {
      var e, t;
      if (i.libs.autoLoad) for (e = 0; e < i.libs.resources.length; e++) {
        if (i.libs.resources[e] instanceof Object) for (t in i.libs.resources[e]) {
          i.loadResource(t, i.libs.resources[e][t]);
        } else i.loadResource(i.libs.resources[e]);
      }
    },
    pxToNumber: function pxToNumber(e, t) {
      if (e || !t) return Number(String(e).replace("px", "")) || 0;
    },
    numberToPx: function numberToPx(e) {
      return String(e) + "px";
    },
    cloneObject: function cloneObject(e) {
      ...
      for (r in e) {
        n = "object" == _typeof(a = e[r]), o = a instanceof Date, t[r] = n && !o ? i.cloneObject(a) : a;
      }

      return t;
    },
    deepMerge: function deepMerge(e, t, a) {
      var r,
          n,
    ...
    isHashbanged: function isHashbanged(e) {
    ...
    isTainted: function isTainted(e) {
    ...
    getAngle: function getAngle(e, t, a, i) {
      var r = a - e,
          n = i - t;
    ...
    gatherAttribute: function gatherAttribute(e, t, a, r) {
      var n,
          r = r || 0,
          a = a || 3;
      return e && !(n = e.getAttribute(t)) && r < a ? i.gatherAttribute(e.parentNode, t, a, r + 1) : n;
    },
    gatherClassName: function gatherClassName(e, t, a, r) {
      var n,
          r = r || 0,
          a = a || 3;
    ...
    gatherElements: function gatherElements(e, t, a) {
      var r, n;
    ...
    capture: function capture(e, t) {
      ...
      if (i.config.legend) {
        if ("stock" == i.setup.chart.type) for (a = 0; a < i.setup.chart.panels.length; a++) {
          ...
          return function (a, l) {
            ...
            if (c.paths = p, c.set(f), i.setup.fabric.add(c), e.svg.parentNode && e.svg.parentNode.getElementsByTagName) {
              ...
              for (d = 0; d < h.length; d++) {
                if (r.balloonFunction instanceof Function) r.balloonFunction.apply(i, [h[d], e]);else {
                  var m = h[d],
    ...
    toCanvas: function toCanvas(e, t) {
      var a = i.deepMerge({}, e || {}),
          r = i.setup.canvas;
      return i.handleCallback(t, r, a), r;
    },
    toImage: function toImage(e, t) {
      var a = i.deepMerge({
        format: "png",
        quality: 1,
    ...
    toSVG: function toSVG(e, t) {
      var a,
          r = [],
          n = [],
          o = i.deepMerge({
        compress: i.config.compress,
        reviver: function reviver(e, t) {
    ...
    toPDF: function toPDF(e, t) {
      var a,
          r = i.deepMerge(i.deepMerge({
    ...
    toByteArray: function toByteArray(e, t) {
      function a(e) {
    ...
    removeFunctionsFromObject: function removeFunctionsFromObject(e) {
      for (var t in e) {
    ...
    handleNamespace: function handleNamespace(e, t) {
      function a() {
    ...
    handleBorder: function handleBorder(e) {
    ...
    handleDropbox: function handleDropbox(e) {
    ...
    getChartData: function getChartData(e) {
      function t(e, t, a) {
        function r(e, t) {
    ...
    getAnnotations: function getAnnotations(e, t) {
      var a,
          r = i.deepMerge({}, e || {}, !0),
          n = [];
    ...
    setAnnotations: function setAnnotations(e, t) {
      var a = i.deepMerge({
        data: []
      }, e || {}, !0);
    ...
    processData: function processData(t) {
      var a,
          r,
          n = i.deepMerge({
        data: [],
    ...
    createMenu: function createMenu(t, a) {
      function r(t, a) {
        var o,
            s,
    ...
    migrateSetup: function migrateSetup(e) {
      function t(e) {
        var i;
