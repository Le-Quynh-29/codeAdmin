...
(function ($) {
  $.fn.extend({
    monthly: function monthly(options) {
      ...
      function setMonthly(m, y) {
        ...
        $('#' + uniqueId + ' .monthly-event-list').empty(); // Print out the days
        ...
        if (options.mode == 'event') {
          ...
          $.get('' + options.xmlUrl + '', function (d) {
            $(d).find('event').each(function () {
              ...
              startPeriod = 'AM', endTime = $(this).find('endtime').text(), endSplit = endTime.split(":");
              ...
              if (!fullendDate && startMonth == setMonth && startYear == setYear) {
                // Add Indicators
                $('#' + uniqueId + ' *[data-number="' + startDay + '"] .monthly-indicator-wrap').append('<div class="monthly-event-indicator"  data-eventid="' + eventId + '" style="background:' + eventColor + '" title="' + eventTitle + '">' + eventTitle + '</div>'); // Print out event list for single day event
      ...
      $(document.body).on('click', '#' + uniqueId + ' a.monthly-day', function (e) {
        ...
        if (options.mode == 'event' && options.eventList == true) {
          ...
          var topPos = myElement.offsetTop; //document.getElementByClassname('scrolling_div').scrollTop = topPos;

          $('#' + uniqueId + ' .monthly-event-list').scrollTop(topPos);
          viewToggleButton(); // If picker, pick date
          ...
          if ($(this).hasClass('monthly-past-day') && options.disablePast == true) {
            ...
            $('' + options.target + '').val(setMonth + '/' + whichDay + '/' + setYear); // ... and then hide the calendar if it started that way
      ...
      $(document.body).on('click', '#' + uniqueId + ' .listed-event', function (e) {
        var href = $(this).attr('href'); // If there isn't a link, don't go anywhere
